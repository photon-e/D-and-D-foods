    ...
    <footer className="border-t border-orange-100 bg-[#1F2937] text-white">
      <div className="container grid gap-10 py-16 lg:grid-cols-[1.3fr_1fr_1fr_1.1fr]">
        <div>
          ...
          <p className="mt-5 max-w-sm leading-7 text-white/70">Jos-based catering and delivery with chef-crafted meals, warm hospitality, and event-ready presentation.</p>
        ...
        <div>
          ...
          <div className="mt-6 space-y-3 text-sm text-white/70">
            <p className="flex items-center gap-2"><Phone className="h-4 w-4" /> +234 803 014 2026</p>
            <p className="flex items-center gap-2"><Mail className="h-4 w-4" /> hello@danddfoods.ng</p>
            <p className="flex items-center gap-2"><MapPin className="h-4 w-4" /> Bukuru Road, Jos, Plateau State</p>
          </div>
        </div>
      </div>
      <div className="border-t border-white/10 py-6 text-center text-sm text-white/60">© 2026 D&D Foods. Crafted in Jos for delivery, catering, and community.</div>
    </footer>
  );
}
