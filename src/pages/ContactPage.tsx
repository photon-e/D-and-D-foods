...
export default function ContactPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Contact" title="Let’s plan something delicious" description="Questions about delivery, catering availability, custom menus, or dietary needs? Send us a note." image="https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=1800&q=85" />
      <section className="container grid gap-8 pb-24 lg:grid-cols-[1.1fr_.9fr]">
        ...
        <div className="space-y-5">
          ...
          <Info icon={<Mail />} title="Email" text="hello@danddfoods.example" />
          <Info icon={<Phone />} title="Phone" text="(555) 014-2026" />
          <Info icon={<MapPin />} title="Location" text="124 Market Street, Your City" />
